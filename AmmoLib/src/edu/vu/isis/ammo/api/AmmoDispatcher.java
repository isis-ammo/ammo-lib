...
import edu.vu.isis.ammo.api.IAmmoRequest.Anon;
import edu.vu.isis.ammo.api.IAmmoRequest.Builder;
import edu.vu.isis.ammo.api.IAmmoRequest.Event;
import edu.vu.isis.ammo.api.IAmmoRequest.Query;
...
public class AmmoDispatcher  {
	...
	private boolean subscribe(Uri provider, String topicType, Calendar expiration, double worth, String filter, PendingIntent notice) {
		...
		Log.d("AmmoDispatcher", "::subscribe with provider: " + provider.toString() + " topicType: " + topicType);

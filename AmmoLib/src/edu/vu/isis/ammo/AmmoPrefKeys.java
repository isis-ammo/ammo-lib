 ...
 *
 */
public final class AmmoPrefKeys {
	// ====================================
	// Ammo Core
	// ====================================
	...
	public static final String PHYSICAL_LINK_SHOULD_USE_PREF_KEY = "edu.vu.isis.ammo.core.physical_link.SHOULD_USE.KEY";
	public static final String WIFI_SHOULD_USE_PREF_KEY = "edu.vu.isis.ammo.core.wifi_link.SHOULD_USE.KEY";
